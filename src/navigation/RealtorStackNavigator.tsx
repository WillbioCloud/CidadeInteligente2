// src/screens/Realtor/RealtorTabScreen.tsx

import React from 'react';
import { View, Text, StyleSheet, SafeAreaView, TouchableOpacity, ScrollView } from 'react-native';
import { useNavigation } from '@react-navigation/native'; // IMPORTADO O HOOK DE NAVEGAÇÃO
...
export default function RealtorTabScreen() {
    const navigation = useNavigation(); // USANDO O HOOK PARA PEGAR A NAVEGAÇÃO
                ...
                <View style={styles.section}>
                    ...
                    {isFbzRealtor && (
                        <DashboardButton
                            ...
                            onPress={() => navigation.navigate('Stock')} // NAVEGAÇÃO REAL
                            theme={theme}
                        />
                    )}
                    ...
                    <DashboardButton
                        ...
                        onPress={() => navigation.navigate('MyClients')} // NAVEGAÇÃO REAL
                        theme={theme}
                    />
                    ...
                    <DashboardButton
                        ...
                        onPress={() => navigation.navigate('SalesMaterials')} // NAVEGAÇÃO REAL
                        theme={theme}
                    />
                     ...
                     <DashboardButton
                        ...
                        onPress={() => navigation.navigate('Performance')} // NAVEGAÇÃO REAL
                        theme={theme}
                    />
                </View>
                 ...
                 <View style={styles.section}>
                    <Text style={styles.sectionTitle}>Link de Indicação</Text>
                     <DashboardButton
                        ...
                        onPress={() => navigation.navigate('ShareLink')} // NAVEGAÇÃO REAL
                        theme={theme}
                    />
                </View>
